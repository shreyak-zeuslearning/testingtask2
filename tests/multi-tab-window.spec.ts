...
// test('TC 001 Verify New Tab button opens a new tab.', async({page,context,browserWindowPage})=>{
...
// test('TC 002 Verify content of newly opened tab ("This is a sample page").', async({page,context,browserWindowPage})=>{
...
// test('TC_003 Close child tab and switch back to parent.', async({page,context,browserWindowPage})=>{
//     await browserWindowPage.goto();
...
// test('Tc 004 Verify New Window Message functionality.', async({page,context,browserWindowPage})=>{
//     await browserWindowPage.goto();
